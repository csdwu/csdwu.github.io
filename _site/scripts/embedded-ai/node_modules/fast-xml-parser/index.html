...
<html lang="en-US">
  ...
  <a class="normal" href="./embedded-ai">Embeded AI</a>
    ...
    <div class="wrapper">
      ...
      <h1 id="fast-xml-parser"><a href="https://www.npmjs.com/package/fast-xml-parser">fast-xml-parser</a></h1>
<p>[![NPM quality][quality-image]][quality-url]
<a href="https://coveralls.io/github/NaturalIntelligence/fast-xml-parser?branch=master"><img src="https://coveralls.io/repos/github/NaturalIntelligence/fast-xml-parser/badge.svg?branch=master" alt="Coverage Status" /></a>
<a href="https://naturalintelligence.github.io/fast-xml-parser/"><img src="https://img.shields.io/badge/Try-me-blue.svg?colorA=FFA500&amp;colorB=0000FF" alt="Try me" /></a>
<a href="https://npm.im/fast-xml-parser"><img src="https://img.shields.io/npm/dt/fast-xml-parser.svg" alt="NPM total downloads" /></a></p>

<p>Validate XML, Parse XML to JS Object, or Build XML from JS Object without C/C++ based libraries and no callback.</p>

<hr />

<p><small>Checkout our new library <a href="https://solothought.com/text2chart/flow">Text2Chart</a> that constructs flow chart out of simple text. Very helpful in creating or alayzing an algorithm, and documentation purpose</small>
<br /></p>

<p>Sponsor this project</p>

<p><a href="https://github.com/sponsors/NaturalIntelligence"> 
...
<p><img src="https://raw.githubusercontent.com/NaturalIntelligence/ThankYouBackers/main/assets/NI_sponsors.jpg" alt="fxp_sponsors" /></p>
<ul>
  <li><a href="https://github.com/cocopon" target="_blank">Hiroki Kokubun</a></li>
</ul>

<blockquote>
  <p>This is a donation. No goods or services are expected in return. Any requests for refunds for those purposes will be rejected.</p>
  <h2 id="users">Users</h2>
</blockquote>

<p><a href="https://github.com/renovatebot/renovate" title="renovate"><img src="https://avatars1.githubusercontent.com/u/38656520" width="60px" /></a>
...
<a href="./USERs.md">more</a></p>

<p><small>The list of users are mostly published by Github or communicated directly. Feel free to contact if you find any information wrong.</small></p>

<hr />

<h2 id="main-features">Main Features</h2>

<p><img align="right" src="static/img/fxp_logo.png" width="180px" alt="FXP logo" /></p>

<ul>
  <li>Validate XML data syntactically</li>
  <li>Parse XML to JS Object</li>
  <li>Build XML from JS Object</li>
  <li>Compatible to node js packages, in browser, and in CLI (click try me button above for demo)</li>
  ...
  <li>unpaired tags (Eg <code class="language-plaintext highlighter-rouge">&lt;br&gt;</code> in HTML), stop nodes (Eg <code class="language-plaintext highlighter-rouge">&lt;script&gt;</code> in HTML) are supported.</li>
...
<h2 id="v5">v5</h2>
<p>I developed v5 in Apr 2023. And I didn’t get the chance to complete all the features. I’ve ensured that new features don’t impact performance. With v5, you have more control on parsing output. Check <a href="./docs/v5">docs</a> for syntax help and basic understanding.</p>

<p>Please leave a comment in discussion forum for your suggestions and if you really need v5.</p>

<h2 id="how-to-use">How to use</h2>

<p>To use as package dependency
<code class="language-plaintext highlighter-rouge">$ npm install fast-xml-parser</code> 
or 
<code class="language-plaintext highlighter-rouge">$ yarn add fast-xml-parser</code></p>

<p>To use as system command
<code class="language-plaintext highlighter-rouge">$ npm install fast-xml-parser -g</code></p>
...
<p>As CLI command</p>
<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nv">$ </span>fxparser some.xml
</code></pre></div></div>

<p>In a node js project</p>
<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">const</span> <span class="p">{</span> <span class="nx">XMLParser</span><span class="p">,</span> <span class="nx">XMLBuilder</span><span class="p">,</span> <span class="nx">XMLValidator</span><span class="p">}</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">"</span><span class="s2">fast-xml-parser</span><span class="dl">"</span><span class="p">);</span>
...
<span class="kd">let</span> <span class="nx">jObj</span> <span class="o">=</span> <span class="nx">parser</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">XMLdata</span><span class="p">);</span>

<span class="kd">const</span> <span class="nx">builder</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">XMLBuilder</span><span class="p">();</span>
<span class="kd">const</span> <span class="nx">xmlContent</span> <span class="o">=</span> <span class="nx">builder</span><span class="p">.</span><span class="nx">build</span><span class="p">(</span><span class="nx">jObj</span><span class="p">);</span>
</code></pre></div></div>

<p>In a HTML page</p>
<div class="language-html highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"path/to/fxp.min.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
:
<span class="nt">&lt;script&gt;</span>
  <span class="kd">const</span> <span class="nx">parser</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">fxparser</span><span class="p">.</span><span class="nx">XMLParser</span><span class="p">();</span>
  <span class="nx">parser</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">xmlContent</span><span class="p">);</span>
<span class="nt">&lt;/script&gt;</span>
</code></pre></div></div>
...
<p><strong>note</strong>: version 5 is released with version 4 tfor experimental use. Based on it’s demand, it’ll be developed and the features can be different in final release.</p>
...
<p><img align="left" src="./docs/imgs/XMLParser_v4.png" width="45%" />
<img src="./docs/imgs/XMLParser_large_v4.png" width="47%" /></p>
...
<h3 id="xml-builder">XML Builder</h3>

<p><img src="./docs/imgs/XMLBuilder_v4.png" width="50%" /></p>
<ul>
  <li>Y-axis: requests per second</li>
</ul>
...
<h2 id="usage-trend">Usage Trend</h2>

<p><a href="https://npm-compare.com/fast-xml-parser#timeRange=THREE_YEARS">Usage Trend of fast-xml-parser</a></p>

<p><a href="https://npm-compare.com/fast-xml-parser#timeRange=THREE_YEARS" target="_blank">
...
<p>This project exists thanks to <a href="graphs/contributors">all</a> the people who contribute. [<a href="docs/CONTRIBUTING.md">Contribute</a>].
<!-- <a href="graphs/contributors"><img src="https://opencollective.com/fast-xml-parser/contributors.svg?width=890&button=false" /></a> -->
&lt;!–</p>
<h3 id="lead-maintainers">Lead Maintainers</h3>
<p><img src="https://avatars1.githubusercontent.com/u/7692328?s=100&amp;v=4" alt="Amit Gupta" />
<a href="https://github.com/Delagen"><img src="https://avatars3.githubusercontent.com/u/783335?s=100&amp;v=4" alt="Vohmyanin Sergey Vasilevich" /></a></p>

<h3 id="all-contributors-">All Contributors –&gt;</h3>
<p><a href="graphs/contributors"><img src="https://opencollective.com/fast-xml-parser/contributors.svg?width=890&amp;button=false" /></a></p>
...
<p><img src="static/img/donation_quote.png" alt="Donate $5" /></p>
